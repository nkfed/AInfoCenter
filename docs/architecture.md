...
**Clawd Bot** — це AI-координатор на базі Clawdbot CLI, розгорнутий у WSL2 середовищі для автоматизації робочих процесів бізнес-аналітика. Система інтегрована з Telegram Bot API, Google Gemini Pro та підтримує віддалений доступ через SSH/VS Code.
